      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold">Resume Test</h3>
                  <p className="text-muted-foreground">
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">How Know Your Resume Works</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  A simple three-step process to transform your resume and boost your job search success.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Simply upload your current resume in PDF, DOCX, or TXT format to get started.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "After using KYR, I received interview calls from 3 companies within a week. The AI suggestions were
                    spot on!"
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "The resume score feature helped me understand exactly what was missing. I landed my dream job after
                    the improvements!"
                  </p>
                </div>
                <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "As a career changer, I was struggling to highlight transferable skills. KYR's AI review transformed
                    my resume completely."
                  </p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="rounded-full bg-muted p-1">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">Essential tools to get started with your resume.</p>
              ...
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">Everything you need for career success.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-primary" />
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Helping job seekers optimize their resumes and land their dream jobs since 2023.
              </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} Know Your Resume. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground">Designed with ❤️ for job seekers everywhere</p>
          </div>
        </div>
      </footer>
    </div>
